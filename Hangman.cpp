// Solution code with modularized loss-check function
#include <iostream>
#include <string>
#include <vector>
#include <cstdlib>
...
string choose_word() {
    vector<string> words = {"Doraemon", "MickeyMouse", "MotuPatlu", "ShinChan", "Barbie", "Cindrella","Chotabheem","Pikachu","Tom","jerry","Dora","Ben10"};
